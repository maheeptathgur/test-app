                                ...
                                <div className="space-y-1">
                                  {copilot.components.filter(c => c.type === 'tool').map((tool) => {
                                    ...
                                    return (
                                      ...
                                      >
                                        <div className="flex items-center justify-between">
                                          <div className="font-medium text-gray-900 truncate" style={{ fontSize: '16px !important' }}>{tool.name}</div>
                                          <ChevronDown className={`w-3 h-3 text-gray-400 transition-transform ${isExpanded ? 'rotate-180' : ''}`} />
                                        </div>
                                        <div className="text-gray-600 truncate" style={{ fontSize: '16px !important' }}>
