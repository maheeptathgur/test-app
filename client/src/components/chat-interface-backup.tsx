      ...
      <span className="whitespace-pre-wrap">
        {parts.map((part, index) => {
          ...
          if (index % 2 === 1) {
            ...
            let badgeClass = "inline-flex items-center mx-1 px-2 py-1 rounded-md text-xs font-medium align-baseline mt-1";
            ...
            <div className="max-w-4xl mx-auto p-3 relative">
              <div className="flex gap-3 relative items-end">
                ...
                <Button 
                  ...
                  className={`h-12 w-12 p-0 self-end mr-2 ${isRecording ? 'bg-red-500 hover:bg-red-600' : ''}`}
