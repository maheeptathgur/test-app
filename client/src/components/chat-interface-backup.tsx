              ...
              <div className="flex-1 space-y-6 overflow-y-auto mt-8">
                ...
                {messages.map((message, index) => {
                  ...
                  return (
                    <div 
                      key={message.id} 
                      className={`flex mb-1 ${message.sender === 'user' ? 'justify-end' : 'justify-start'}`}
                    >
                      <div className={`max-w-[75%] ${message.sender === 'user' ? 'mr-2' : 'ml-2'}`}>
                        <div 
                        ...
                        {/* Show full timestamp on hover for better context */}
                        {!isConsecutive && (
                ...
                {/* Show interaction buttons for the last bot message */}
                {messages.length > 0 && 
                  ...
                  <div className="flex justify-start ml-2 mb-4">
                    <div className="max-w-[75%]">
                      {(() => {
                        ...
                        return (
                          <div className="mt-2 pt-2 border-t border-gray-100 bg-white rounded-lg p-3 shadow-sm">
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                <Button
                                  variant="ghost"
                                  ...
                                  className={`h-8 px-3 text-xs hover:bg-gray-200 hover:text-gray-900 ${
                                    copiedMessages.has(lastBotMessage.id) ? 'text-green-600 bg-green-50' : ''
                                  }`}
                                  onClick={() => handleCopyMessage(lastBotMessage.content, lastBotMessage.id)}
                                >
                                  {copiedMessages.has(lastBotMessage.id) ? (
                                    <>
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  className={`h-8 px-3 text-xs hover:bg-gray-200 hover:text-gray-900 ${
                                    likedMessages.has(lastBotMessage.id) ? 'text-green-600 bg-green-50' : ''
                                  }`}
                                  onClick={() => handleLikeMessage(lastBotMessage.id)}
                                >
                                  {likedMessages.has(lastBotMessage.id) ? (
                                    <>
                                      <Check className="w-3 h-3 mr-1" />
                                      Liked
                                    </>
                                ...
                                {feedbackForms[lastBotMessage.id]?.type === 'dislike' && feedbackForms[lastBotMessage.id]?.submitted ? (
                                  ...
                                  <Button
                                    ...
                                    size="sm"
                                    className="h-8 px-3 text-xs hover:bg-gray-200 hover:text-gray-900"
                                    onClick={() => handleDislikeMessage(lastBotMessage.id)}
                                  >
                              ...
                              {feedbackForms[lastBotMessage.id]?.type === 'askHuman' && feedbackForms[lastBotMessage.id]?.submitted ? (
                                <div className="text-xs text-green-600 bg-green-50 px-2 py-1 rounded h-8 flex items-center">
                                  <Check className="w-3 h-3 mr-1" />
                                  Sent
                                </div>
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  className="h-8 px-3 text-xs hover:bg-gray-200 hover:text-gray-900"
                                  onClick={() => handleAskHuman(lastBotMessage.id)}
                                >
                            ...
                            {/* Feedback form */}
                            {feedbackForms[lastBotMessage.id]?.visible && (
                              <div className="mt-3 p-3 bg-gray-50 rounded-lg">
                                <div className="flex items-center justify-between mb-2">
                                  <div className="text-sm font-medium text-gray-700">
                                    {feedbackForms[lastBotMessage.id].type === 'dislike' 
                                  ...
                                  <Button
                                    variant="ghost"
                                    size="sm"
                                    onClick={() => handleCloseFeedback(lastBotMessage.id)}
                                ...
                                <div className="flex gap-2">
                                  <Input
                                    placeholder={feedbackForms[lastBotMessage.id].type === 'dislike' 
                                      ? "Tell us what went wrong..." 
                                      : "Describe what you need help with..."}
                                    value={feedbackForms[lastBotMessage.id].text}
                                    onChange={(e) => handleUpdateFeedback(lastBotMessage.id, e.target.value)}
                                    className="flex-1"
                                  />
                                  <Button
                                    size="sm"
                                    onClick={() => handleSubmitFeedback(lastBotMessage.id)}
                                    disabled={!feedbackForms[lastBotMessage.id].text.trim()}
                                  >
                                    Send
                                  </Button>
                                </div>
