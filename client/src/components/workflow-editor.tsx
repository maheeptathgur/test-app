...
export function WorkflowEditor({ workflowId = 'email-campaign', onBack }: WorkflowEditorProps) {
  ...
  return (
    <div className="workflow-editor h-full flex flex-col" style={{ backgroundColor: 'var(--theme-background)' }}>
      {/* Header */}
      ...
      <div className="flex-1 overflow-auto">
        {activeTab === 'steps' && (
          <div className="workflow-tab-content px-8 pb-24 pt-6 space-y-6" style={{ backgroundColor: 'var(--theme-background)' }}>
