...
- July 7, 2025. Updated copilot card images with custom illustrations - Campaign Manager uses marketing-themed image with charts and analytics, Customer Support uses support-themed image with chat interfaces and video elements, Social Analyst uses analytics-themed image with social media monitoring dashboard and data visualization charts, Resume Assistant uses professional resume and career-focused interface design, while Content Assistant maintains the general workspace illustration for consistent branding
```
