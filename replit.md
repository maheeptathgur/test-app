...
- July 7, 2025. Updated copilot card images with custom illustrations - Campaign Manager now uses marketing-themed image with charts and analytics, Customer Support uses support-themed image with chat interfaces and customer service elements, while other copilots maintain the general workspace illustration for consistent branding
```
