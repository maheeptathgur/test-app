...
- July 5, 2025. Enhanced copilot card dropdown menu button visibility - changed from transparent white background (bg-white/20) to solid dark background (bg-black/60) with hover state (bg-black/80) and added white border for better photo visibility and on-brand appearance
```
